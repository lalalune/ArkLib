...
| `T4.8` | AHIV17 general-code unique-decoding | proof present; epsCA wrapper open | [`ProximityGap/AHIV22.lean`](../../../ArkLib/Data/CodingTheory/ProximityGap/AHIV22.lean) (sorry-free as of `05a010e3`), [ProximityGap/Errors.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/Errors.lean) | `ABF26.ahiv17_epsCA_bound` (ε-wrapping of existing AHIV22 result) | Previously `present-but-incomplete`; PR #385 closed the AHIV22 proof holes. The remaining work is the ABF26-facing `epsCA` wrapper/API wiring, tracked by #80. |
