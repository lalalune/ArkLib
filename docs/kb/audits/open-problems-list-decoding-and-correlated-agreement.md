...
| `L4.19` | CA bounded below by sampling probability | stated (external Prop; split issue) | [CapacityBounds.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/CapacityBounds.lean), related DG25 residual work in [DG25/MainResults.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/DG25/MainResults.lean) | `CodingTheory.linear_epsCA_sampling_dg25_mass`, `CodingTheory.linear_epsCA_ge_sampling_dg25` | Prop-valued DG25 Thm 2.5 statement. The named sampling mass isolates `((q-1)/q)·Pr_u[Δ(u,C)≤δ]`; the DG25 files prove a different proximity-gap branch, so the covering-radius sampling lower bound remains tracked by #77. |
