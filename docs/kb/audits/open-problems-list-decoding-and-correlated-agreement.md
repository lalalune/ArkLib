...
| `C6.9` | Construction 6.9 (attack target) | deferred | related framework in [OracleReduction/Basic.lean](../../../ArkLib/OracleReduction/Basic.lean) | `ToyProblem.Spec.protocol69` | Simplified IOR `T'[C, t]`; lands as a sibling `Spec/General.lean` section. |
