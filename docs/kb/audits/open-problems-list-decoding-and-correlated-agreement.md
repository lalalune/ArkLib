...
| `T2.18` | FRS and UM are subspace-design | present-but-incomplete | [SubspaceDesign.lean](../../../ArkLib/Data/CodingTheory/SubspaceDesign.lean) | `CodingTheory.frs_is_subspaceDesign_gk16` | FRS half is formalized (the deep GK16 degree-budget lemmas are proved for the vector-space side). UM half remains deferred. |
...
| `T3.2` | Johnson bound (Joh62) | refuted (unguarded paper statement) / present | absolute-distance form `johnson_bound`, `johnson_bound_alphabet_free` in [JohnsonBound/Basic.lean](../../../ArkLib/Data/CodingTheory/JohnsonBound/Basic.lean); refuted `johnson_bound_lambda_le_ell` in [JohnsonBound/FamilyRefutationComplete.lean](../../../ArkLib/Data/CodingTheory/JohnsonBound/FamilyRefutationComplete.lean) | `CodingTheory.johnson_bound_lambda_le_ell_false` | The unguarded `johnson_bound_lambda_le_ell` statement over abstract alphabets is false and the in-tree refutation is complete; use the corrected absolute-distance forms instead. |
| `C3.3` | MDS coarse Johnson | present | [JohnsonBound/Family.lean](../../../ArkLib/Data/CodingTheory/JohnsonBound/Family.lean) | `CodingTheory.mds_johnson_lambda_le` | Fully proved in-tree from scratch using the radical-free simplex Johnson quadratic cap, bypassing the refuted T3.2 statement. |
| `T3.4` | τ-subspace-design list decoding | stated (external Prop) | [ListDecoding/Bounds.lean](../../../ArkLib/Data/CodingTheory/ListDecoding/Bounds.lean), [CZ25SpanDimension.lean](../../../ArkLib/Data/CodingTheory/ListDecoding/CZ25SpanDimension.lean) | `CodingTheory.subspaceDesign_list_decoding_cz25` | Prop-valued CZ25 Thm B.5 statement. The unguarded residual `CZ25SpanBound` was refuted; the true target is now the guarded `CZ25SpanBound'`. The `_of_residual` theorem proves the packaging from the corrected residual; the external content is the CZ25 design-to-`Λ` conversion. |
| `C3.5` | Folded RS up to capacity | stated (external Prop) | [ListDecoding/Bounds.lean](../../../ArkLib/Data/CodingTheory/ListDecoding/Bounds.lean) | `CodingTheory.frs_list_decoding_capacity_cz25` | Prop-valued CZ25 Cor 2.21 statement. The reductions derive it from T3.4 (via the guarded `CZ25SpanBound'`) plus T2.18 residual inputs. |
