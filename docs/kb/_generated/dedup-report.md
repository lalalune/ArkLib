...
- `ArkLib` — 283 files, 5341 declarations
...
- `def Binius.BinaryBasefold.disagreementSet` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1417](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1417) — Disagreement set Δ : The set of points where two functions disagree. For functions f^(i+ϑ) and g^(i+
