...
- `ArkLib` — 534 files, 10582 declarations

## Same short-name across multiple files (425 groups)
...
- `def Sumcheck.Spec.SingleRound.oracleVerifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1348](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1348) — The oracle verifier for the `i`-th round of the sum-check protocol. Migrated to the new `OracleState
...
- `def Sumcheck.Spec.SingleRound.reduction` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1367](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1367) — The sum-check reduction for the `i`-th round of the sum-check protocol
...
- `def Binius.BinaryBasefold.OracleStatement` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:528](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L528) — For the `i`-th round of the protocol, there will be oracle statements corresponding to all committed
...
- `def Sumcheck.Spec.SingleRound.oracleReduction` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1377](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1377) — The sum-check oracle reduction for the `i`-th round of the sum-check protocol. Migrated to the new `
...
- `def Sumcheck.Spec.SingleRound.verifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1338](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1338) — The verifier for the `i`-th round of the sum-check protocol
- `def Sumcheck.Spec.SingleRound.Unfolded.verifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1884](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1884) — The (non-oracle) verifier of the sum-check protocol for the `i`-th round, where `i < n + 1`
...
- `def Sumcheck.Spec.SingleRound.Unfolded.prover` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1874](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1874) — The overall prover for the `i`-th round of the sum-check protocol, where `i < n`. This is only well-
...
- `structure Binius.BinaryBasefold.Witness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:549](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L549) — The round witness for round `i` of `t ∈ L[≤ 2][X Fin ℓ]` and `Hᵢ(Xᵢ, ..., Xₗ₋₁) := h(r₀', ..., rᵢ₋₁'
...
### `disagreementSet` (5 declarations, 5 files)
...
- `def Binius.BinaryBasefold.disagreementSet` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:118](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L118) — Disagreement set Δ : The set of points where two functions disagree. For functions f^(i) and g^(i), 
...
### `finalSumcheckKStateProp` (5 declarations, 5 files)

- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1245](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1245) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:1657](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L1657) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKStateProp` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1334](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1334) — (no docstring)
...
- `def RingSwitching.SumcheckPhase.finalSumcheckKStateProp` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1169](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1169) — (no docstring)

### `finalSumcheckKnowledgeStateFunction` (5 declarations, 5 files)

- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1279](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1279) — The knowledge state function for the final sumcheck step
- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:1687](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L1687) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1374](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1374) — The knowledge state function for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1206](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1206) — The knowledge state function for the final sumcheck step

### `finalSumcheckOracleReduction` (5 declarations, 5 files)

- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1168](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1168) — The oracle reduction for the final sumcheck step
- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:115](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L115) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:644](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L644) — The oracle reduction for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:976](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L976) — The oracle reduction for the final sumcheck step

### `finalSumcheckOracleReduction_perfectCompleteness` (5 declarations, 5 files)

- `theorem Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1182](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1182) — Perfect completeness for the final sumcheck step
- `theorem Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:130](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L130) — (no docstring)
- `theorem Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1105](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1105) — Perfect completeness for the final sumcheck step
...
- `theorem RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1069](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1069) — Perfect completeness for the final sumcheck step

### `finalSumcheckOracleVerifier_rbrKnowledgeSoundness` (5 declarations, 5 files)

- `theorem Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1310](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1310) — Round-by-round knowledge soundness for the final sumcheck step
- `theorem Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:1880](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L1880) — (no docstring)
...
- `theorem RingSwitching.SumcheckPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1328](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1328) — Round-by-round knowledge soundness for the final sumcheck step

### `finalSumcheckProver` (5 declarations, 5 files)

- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckProver` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1082](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1082) — The prover for the final sumcheck step
- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckProver` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:55](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L55) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckProver` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:586](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L586) — The prover for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckProver` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:882](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L882) — The prover for the final sumcheck step

### `finalSumcheckRbrExtractor` (5 declarations, 5 files)

- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1215](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1215) — The round-by-round extractor for the final sumcheck step
- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:1615](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L1615) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1296](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1296) — The round-by-round extractor for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1149](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1149) — The round-by-round extractor for the final sumcheck step

### `finalSumcheckVerifier` (5 declarations, 5 files)

- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1124](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1124) — The verifier for the final sumcheck step
- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:89](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L89) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:620](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L620) — The verifier for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckVerifier` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:918](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L918) — The verifier for the final sumcheck step
...
- `def coreInteractionOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:1652](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L1652) — (no docstring)
...
- `def RingSwitching.SumcheckPhase.coreInteractionOracleReduction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1431](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1431) — Large-field reduction: Sumcheck seqCompose, then append FinalSum

### `coreInteractionOracleVerifier` (4 declarations, 4 files)

- `def coreInteractionOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:1636](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L1636) — (no docstring)
...
- `def RingSwitching.SumcheckPhase.coreInteractionOracleVerifier` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1395](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1395) — Large-field reduction verifier: Sumcheck seqCompose, then append FinalSum
...
- `theorem Binius.RingSwitching.FullRingSwitching.fullOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/RingSwitching/General.lean:124](../../../ArkLib/ProofSystem/Binius/RingSwitching/General.lean#L124) — (no docstring)
...
- `theorem Binius.BinaryBasefold.FullBinaryBasefold.fullOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean:153](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean#L153) — Round-by-round knowledge soundness for the full Binary Basefold oracle verifier
- `theorem Binius.FRIBinius.FullFRIBinius.fullOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:266](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L266) — Round-by-round knowledge soundness for the full FRI-Binius oracle verifier.
- `theorem Binius.RingSwitching.FullRingSwitching.fullOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/General.lean:151](../../../ArkLib/ProofSystem/Binius/RingSwitching/General.lean#L151) — Round-by-round knowledge soundness for the full ring-switching oracle verifier
...
- `def Binius.BinaryBasefold.FullBinaryBasefold.fullRbrKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean:143](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean#L143) — Combined RBR knowledge soundness error for the full protocol
- `def Binius.FRIBinius.FullFRIBinius.fullRbrKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:256](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L256) — Combined RBR knowledge error for full FRI-Binius.
- `def Binius.RingSwitching.FullRingSwitching.fullRbrKnowledgeError` [ArkLib/ProofSystem/Binius/RingSwitching/General.lean:144](../../../ArkLib/ProofSystem/Binius/RingSwitching/General.lean#L144) — (no docstring)
...
- `theorem Sumcheck.Spec.SingleRound.Simple.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1214](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1214) — Round-by-round knowledge soundness for the oracle verifier
...
### `finalSumcheckKnowledgeError` (4 declarations, 4 files)

- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1204](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1204) — RBR knowledge error for the final sumcheck step
- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:307](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L307) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1285](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1285) — RBR knowledge error for the final sumcheck step
...
### `masterKStateProp` (4 declarations, 4 files)

- `def Binius.BinaryBasefold.masterKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:1129](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L1129) — Before V's challenge of the `i-th` foldStep, we ignore the bad-folding-event of the `i-th` oracle if
- `def Binius.BinaryBasefold.masterKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:750](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L750) — Before V's challenge of the `i-th` foldStep, we ignore the bad-folding-event of the `i-th` oracle if
...
### `witnessStructuralInvariant` (4 declarations, 4 files)

- `def Binius.BinaryBasefold.witnessStructuralInvariant` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:892](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L892) — This condition ensures that the witness polynomial `H` has the correct structure `eq(...) * t(...)`
- `def Binius.BinaryBasefold.witnessStructuralInvariant` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:282](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L282) — This condition ensures that the witness polynomial `H` has the correct structure `eq(...) * t(...)`.
...
- `def Binius.FRIBinius.FullFRIBinius.batchingCoreRbrKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:246](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L246) — Combined RBR knowledge error for batching + core interaction.
- `def Binius.RingSwitching.FullRingSwitching.batchingCoreRbrKnowledgeError` [ArkLib/ProofSystem/Binius/RingSwitching/General.lean:138](../../../ArkLib/ProofSystem/Binius/RingSwitching/General.lean#L138) — (no docstring)
- `def RingSwitching.FullRingSwitching.batchingCoreRbrKnowledgeError` [ArkLib/ProofSystem/RingSwitching/General.lean:146](../../../ArkLib/ProofSystem/RingSwitching/General.lean#L146) — (no docstring)
...
- `def Binius.BinaryBasefold.CoreInteraction.finalSumcheckStepLogic` [ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean:907](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean#L907) — The Logic Instance for the final sumcheck step. This is a 1-message protocol where the prover sends 
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckStepLogic` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:553](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L553) — The logic instance for the FRI final sumcheck step.
...
- `lemma Binius.BinaryBasefold.CoreInteraction.finalSumcheckStep_is_logic_complete` [ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean:1357](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean#L1357) — Final sumcheck step logic is strongly complete. **Key Proof Obligations:** 1. **Verifier Check**: Sh
- `lemma Binius.FRIBinius.CoreInteractionPhase.finalSumcheckStep_is_logic_complete` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1052](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1052) — Strong completeness of the FRI final sumcheck logic step.
...
- `lemma Binius.BinaryBasefold.CoreInteraction.finalSumcheckStep_verifierCheck_passed` [ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean:1218](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean#L1218) — The verifier check passes in the final sumcheck step. **Proof structure:** 1. From `sumcheckConsiste
- `lemma Binius.FRIBinius.CoreInteractionPhase.finalSumcheckStep_verifierCheck_passed` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:967](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L967) — Verifier check passes in the FRI final sumcheck logic step.
...
- `theorem Sumcheck.Spec.SingleRound.Simple.oracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1031](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1031) — Perfect completeness for the oracle reduction
...
### `FinalSumcheckWit` (3 declarations, 3 files)

- `def Binius.BinaryBasefold.CoreInteraction.FinalSumcheckWit` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1209](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1209) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.FinalSumcheckWit` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:1609](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L1609) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.FinalSumcheckWit` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1290](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1290) — (no docstring)
...
- `def Binius.BinaryBasefold.CoreInteraction.foldOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:102](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L102) — (no docstring)
...
### `farness_implies_non_compliance` (3 declarations, 3 files)

- `lemma Binius.BinaryBasefold.farness_implies_non_compliance` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:1008](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L1008) — Farness implies non-compliance. If `f_i` is far from its code `C_i`, it cannot be compliant. This fo
- `lemma Binius.BinaryBasefold.farness_implies_non_compliance` [ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean:73](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean#L73) — Farness implies non-compliance. If `f_i` is far from its code `C_i`, it cannot be compliant. This fo
- `lemma Binius.BinaryBasefold.farness_implies_non_compliance` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:2253](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L2253) — Farness implies non-compliance. If `f_i` is far from its code `C_i`, it cannot be compliant. This fo

### `foldingBadEvent` (3 declarations, 3 files)

- `def Binius.BinaryBasefold.foldingBadEvent` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:1132](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L1132) — **Definition 4.19** Bad event for folding : This event captures two scenarios where the random foldi
- `def Binius.BinaryBasefold.foldingBadEvent` [ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean:182](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean#L182) — **Definition 4.20** Bad event for folding : This event captures two scenarios where the random foldi
- `def Binius.BinaryBasefold.foldingBadEvent` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:2282](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L2282) — Bad event for folding (Definition 4.19) : This event captures two scenarios where the random folding

### `isCompliant` (3 declarations, 3 files)

- `def Binius.BinaryBasefold.isCompliant` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:981](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L981) — Compliance condition (Definition 4.17) : For an index `i` that is a multiple of `steps`, the oracle 
- `def Binius.BinaryBasefold.isCompliant` [ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean:47](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean#L47) — Compliance condition (Definition 4.18) : For an index `i` that is a multiple of `steps`, the oracle 
- `def Binius.BinaryBasefold.isCompliant` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:2220](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L2220) — Compliance condition (Definition 4.17) : For an index `i` that is a multiple of `steps`, the oracle 
...
- `theorem Sumcheck.Spec.SingleRound.reduction_perfectCompleteness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1773](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1773) — (no docstring)
...
- `def ArkLib.BetaToCurveCoeffPolys.CurveCoeffPolys` [ArkLib/ToMathlib/BetaToCurveCoeffPolys.lean:165](../../../ArkLib/ToMathlib/BetaToCurveCoeffPolys.lean#L165) — (no docstring)
...
- `theorem RingSwitching.BatchingPhase.batchingOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/BatchingPhase.lean:563](../../../ArkLib/ProofSystem/RingSwitching/BatchingPhase.lean#L563) — RBR knowledge soundness for the batching phase oracle verifier. `IsDomain K` (alongside the existing
...
- `theorem RingSwitching.BatchingPhase.batchingReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/BatchingPhase.lean:523](../../../ArkLib/ProofSystem/RingSwitching/BatchingPhase.lean#L523) — Perfect completeness for the batching phase oracle reduction.
...
- `theorem ProximityGap.MultiplicativeRigidity.binomial_separation` [ArkLib/Data/CodingTheory/ProximityGap/MultiplicativeRigidityFiber.lean:153](../../../ArkLib/Data/CodingTheory/ProximityGap/MultiplicativeRigidityFiber.lean#L153) — **Binomial separation.** If `0 < b < a ≤ k`, then two distinct monomials `c₁ * X ^ a` and `c₂ * X ^ 
- `theorem MultiplicativeRigidity.binomial_separation` [ArkLib/Data/CodingTheory/ProximityGap/MultiplicativeRigidityZMod.lean:166](../../../ArkLib/Data/CodingTheory/ProximityGap/MultiplicativeRigidityZMod.lean#L166) — **Binomial separation.** Packaging of coset rigidity in the form the dossier consumes: if `b < a < k
...
- `def coreInteractionOracleRbrKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:1700](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L1700) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleRbrKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1688](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1688) — (no docstring)

### `coreInteractionOracleReduction_perfectCompleteness` (2 declarations, 2 files)

- `theorem coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:1672](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L1672) — (no docstring)
...
- `theorem coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:1708](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L1708) — (no docstring)
- `theorem Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1697](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1697) — Round-by-round knowledge soundness for the core interaction oracle verifier

### `coreInteractionRbrKnowledgeError` (2 declarations, 2 files)

- `def Binius.RingSwitching.SumcheckPhase.coreInteractionRbrKnowledgeError` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1753](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1753) — standard sumcheck error
- `def RingSwitching.SumcheckPhase.coreInteractionRbrKnowledgeError` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1487](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1487) — standard sumcheck error
...
- `theorem RingSwitching.SumcheckPhase.coreInteraction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1457](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1457) — Perfect completeness for large-field reduction (Sumcheck ++ FinalSum)

### `coreInteraction_rbrKnowledgeSoundness` (2 declarations, 2 files)

- `theorem Binius.RingSwitching.SumcheckPhase.coreInteraction_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1775](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1775) — RBR knowledge soundness for large-field reduction (Sumcheck ++ FinalSum)
- `theorem RingSwitching.SumcheckPhase.coreInteraction_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1498](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1498) — RBR knowledge soundness for large-field reduction (Sumcheck ++ FinalSum)
...
- `def StirIOP.degree` [ArkLib/ProofSystem/Stir/MainThm.lean:42](../../../ArkLib/ProofSystem/Stir/MainThm.lean#L42) — **Degree after `i` folds:** The starting degree is `deg`; every fold divides it by `foldingParamⱼ (j
...
- `abbrev DuplexSpongeFS.DSTraceStorage.duplexSpongeTraceEntry` [ArkLib/OracleReduction/FiatShamir/DuplexSponge/Security/TraceDataStructures.lean:58](../../../ArkLib/OracleReduction/FiatShamir/DuplexSponge/Security/TraceDataStructures.lean#L58) — A single query-answer entry of a `DuplexSpongeTrace`, i.e. one element of the underlying `QueryLog` 
...
- `def DuplexSpongeFS.DSTraceStorage.ListBacked.empty` [ArkLib/OracleReduction/FiatShamir/DuplexSponge/Security/TraceDataStructures.lean:540](../../../ArkLib/OracleReduction/FiatShamir/DuplexSponge/Security/TraceDataStructures.lean#L540) — (no docstring)
- `def ProtocolSpec.empty` [ArkLib/OracleReduction/ProtocolSpec/Basic.lean:43](../../../ArkLib/OracleReduction/ProtocolSpec/Basic.lean#L43) — The empty protocol specification, with no messages or challenges, written as `!p[]`.
...
- `lemma ProximityGap.exists_coordinate_subset_with_many_nonbad_of_heavy_complement_card` [ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/ListDecoding/Agreement.lean:6512](../../../ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/ListDecoding/Agreement.lean#L6512) — Complement-to-incidence form of the heavy-coordinate argument.  If a coordinate is not heavy for the
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckProverComputeMsg` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:541](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L541) — Pure prover message computation for FRI final sumcheck step.
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckProverWitOut` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:548](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L548) — Pure prover output witness for FRI final sumcheck step.
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckVerifierCheck` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:515](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L515) — Pure verifier check for FRI final sumcheck step.
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckVerifierStmtOut` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:526](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L526) — Pure verifier output for FRI final sumcheck step.
...
- `lemma Binius.BinaryBasefold.CoreInteraction.firstOracleWitnessConsistency_unique` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:750](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L750) — (no docstring)
...
### `foldPrvState` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.foldPrvState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:185](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L185) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.foldPrvState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:50](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L50) — Most security properties happen at FoldStep, the CommitmentRound is just to place the conditional or

### `fullOracleVerifier_knowledgeSoundness` (2 declarations, 2 files)

- `theorem Binius.FRIBinius.FullFRIBinius.fullOracleVerifier_knowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:579](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L579) — Scalar KS for the full stack with error **`concreteFRIBiniusKnowledgeError`**, i.e. **DP24 §5.2 (43)
- `theorem Binius.RingSwitching.FullRingSwitching.fullOracleVerifier_knowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/General.lean:365](../../../ArkLib/ProofSystem/Binius/RingSwitching/General.lean#L365) — Scalar KS with error `fullRingSwitchingConcreteKnowledgeError κ L ℓ' ε_pcs` (Protocol 3.1 front + `ε
...
### `getFoldProverFinalOutput` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.getFoldProverFinalOutput` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:210](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L210) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.getFoldProverFinalOutput` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:66](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L66) — This is in fact usable immediately after the V->P challenge since all inputs are available at that t

### `getSumcheckRoundPoly_eval_eq_sum_snoc` (2 declarations, 2 files)

- `theorem RingSwitching.SumcheckPhase.getSumcheckRoundPoly_eval_eq_sum_snoc` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:250](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L250) — **Target (b): `getSumcheckRoundPoly` value as a cube sum (LAST-variable/`snoc` form, defect-#20 repa
...
- `lemma ProximityGap.heavyCoords_card_mul_le` [ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/ListDecoding/Agreement.lean:6470](../../../ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/ListDecoding/Agreement.lean#L6470) — Generic double-counting brick for Claim 5.11. If each `z ∈ S` has at most `m` bad coordinates, then 
...
- `instance Sumcheck.Spec.SingleRound.instOracleVerifierAppendCoherent` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1355](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1355) — The `i`-th-round oracle verifier routes its (single) output oracle to the (unchanged) input oracle (
...
- `lemma Binius.BinaryBasefold.QueryPhase.iteratedQuotientMap_eq_qMap_total_fiber_extractMiddleFinMask` [ArkLib/ProofSystem/Binius/BinaryBasefold/QueryPhase.lean:314](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/QueryPhase.lean#L314) — (no docstring)
...
- `def RingSwitching.SumcheckPhase.iteratedSumcheckKStateProp` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:574](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L574) — This follows the KState of `foldKStateProp`
...
- `def RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:636](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L636) — Knowledge state function (KState) for single round
...
- `theorem RingSwitching.SumcheckPhase.iteratedSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:192](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L192) — (no docstring)
...
- `theorem RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:843](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L843) — RBR knowledge soundness for a single round oracle verifier
...
- `def RingSwitching.SumcheckPhase.iteratedSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:509](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L509) — (no docstring)
...
- `def RingSwitching.SumcheckPhase.iteratedSumcheckRoundKnowledgeError` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1484](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1484) — Per-round knowledge error for the iterated sumcheck rounds.

### `iterated_fold_to_const_strict` (2 declarations, 2 files)

- `lemma Binius.BinaryBasefold.CoreInteraction.iterated_fold_to_const_strict` [ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean:976](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean#L976) — **Strict version**: When folding the last oracle to level `ℓ` (final sumcheck), the iterated fold of
- `lemma Binius.FRIBinius.CoreInteractionPhase.iterated_fold_to_const_strict` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:709](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L709) — Strict helper: folding the last oracle block in the final sumcheck step yields the constant function
...
- `theorem Reduction.liftContext_completeness` [ArkLib/OracleReduction/LiftContext/Reduction.lean:774](../../../ArkLib/OracleReduction/LiftContext/Reduction.lean#L774) — Lifting the reduction preserves completeness, assuming the lens satisfies its completeness condition
...
- `theorem Verifier.liftContext_knowledgeSoundness` [ArkLib/OracleReduction/LiftContext/Reduction.lean:924](../../../ArkLib/OracleReduction/LiftContext/Reduction.lean#L924) — (no docstring)
...
- `theorem Reduction.liftContext_perfectCompleteness` [ArkLib/OracleReduction/LiftContext/Reduction.lean:879](../../../ArkLib/OracleReduction/LiftContext/Reduction.lean#L879) — (no docstring)
...
- `theorem Verifier.liftContext_rbr_knowledgeSoundness` [ArkLib/OracleReduction/LiftContext/Reduction.lean:1671](../../../ArkLib/OracleReduction/LiftContext/Reduction.lean#L1671) — (no docstring)
...
- `theorem Verifier.liftContext_rbr_soundness` [ArkLib/OracleReduction/LiftContext/Reduction.lean:1423](../../../ArkLib/OracleReduction/LiftContext/Reduction.lean#L1423) — (no docstring)
...
- `theorem Verifier.liftContext_soundness` [ArkLib/OracleReduction/LiftContext/Reduction.lean:901](../../../ArkLib/OracleReduction/LiftContext/Reduction.lean#L901) — Lifting the reduction preserves soundness, assuming the lens satisfies its soundness conditions
...
- `lemma OptionT.mem_support_simulateQ_id'_liftM_query` [ArkLib/ToVCVio/Lemmas.lean:415](../../../ArkLib/ToVCVio/Lemmas.lean#L415) — **Generic**: any element of the range of a query is in the support of `simulateQ (fun t => liftM (qu
- `lemma mem_support_simulateQ_id'_liftM_query` [ArkLib/ToVCVio/Simulation.lean:215](../../../ArkLib/ToVCVio/Simulation.lean#L215) — (no docstring)
...
- `theorem ProximityGap.MultiplicativeRigidity.pow_eq_card_eq_zero_or_gcd` [ArkLib/Data/CodingTheory/ProximityGap/MultiplicativeRigidityFiber.lean:62](../../../ArkLib/Data/CodingTheory/ProximityGap/MultiplicativeRigidityFiber.lean#L62) — **Lemma 1 (monomial agreement / coset rigidity).** In a finite cyclic commutative group `G` of order
- `theorem MultiplicativeRigidity.pow_eq_card_eq_zero_or_gcd` [ArkLib/Data/CodingTheory/ProximityGap/MultiplicativeRigidityZMod.lean:95](../../../ArkLib/Data/CodingTheory/ProximityGap/MultiplicativeRigidityZMod.lean#L95) — **Coset rigidity / monomial agreement (core).** In a finite cyclic group `G` of order `n = Fintype.c
...
- `def Binius.BinaryBasefold.QueryPhase.queryOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/QueryPhase.lean:171](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/QueryPhase.lean#L171) — The oracle reduction for the final query phase.
...
- `lemma Sumcheck.Spec.SingleRound.reduction_verifier_eq_verifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1391](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1391) — (no docstring)
...
- `abbrev RingSwitching.SumcheckPhase.roundKnowledgeError` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:230](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L230) — (no docstring)
...
- `theorem CodingTheory.rs_lambda_high_rate_jh01` [ArkLib/Data/CodingTheory/ListDecoding/Bounds.lean:1737](../../../ArkLib/Data/CodingTheory/ListDecoding/Bounds.lean#L1737) — **ABF26 Theorem 3.14 [JH01 Thm 2], repaired list-size form.** Large-rate Reed-Solomon lower bound. F
...
- `def ArkLib.Claim59Conditional.shiftSeries` [ArkLib/ToMathlib/Claim59Conditional.lean:70](../../../ArkLib/ToMathlib/Claim59Conditional.lean#L70) — The BCIKS shift series `X ↦ X − x₀`, i.e. the substituted series underlying `γ`: `shift 0 = fieldTo𝕃
...
- `lemma Sumcheck.Spec.SingleRound.Simple.simulateQ_oracleVerify_eq` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:963](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L963) — Closed form of the simulated oracle-verifier `verify`: the inner `simOracle2` simulation collapses t
...
- `def Binius.BinaryBasefold.sumcheckConsistencyProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:288](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L288) — Sumcheck consistency: the claimed sum equals the actual polynomial evaluation sum
...
- `lemma Binius.FRIBinius.CoreInteractionPhase.sumcheckConsistency_at_last_simplifies` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:661](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L661) — At `Fin.last ℓ'`, sumcheck consistency simplifies to a single evaluation.
...
- `def sumcheckFoldOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:821](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L821) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.sumcheckFoldOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:152](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L152) — (no docstring)

### `sumcheckFoldOracleReduction_perfectCompleteness` (2 declarations, 2 files)

- `theorem sumcheckFoldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:1105](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L1105) — (no docstring)
- `theorem Binius.FRIBinius.CoreInteractionPhase.sumcheckFoldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:250](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L250) — (no docstring)

### `sumcheckFoldOracleVerifier` (2 declarations, 2 files)

- `def sumcheckFoldOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:540](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L540) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.sumcheckFoldOracleVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:145](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L145) — (no docstring)

### `sumcheckFoldOracleVerifier_rbrKnowledgeSoundness` (2 declarations, 2 files)

- `theorem sumcheckFoldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:1565](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L1565) — (no docstring)
- `theorem Binius.FRIBinius.CoreInteractionPhase.sumcheckFoldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:419](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L419) — (no docstring)
...
- `def RingSwitching.SumcheckPhase.sumcheckLoopOracleReduction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1368](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1368) — Composed oracle reduction for the SumcheckStep (seqCompose over ℓ')
...
- `def RingSwitching.SumcheckPhase.sumcheckLoopOracleVerifier` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1349](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1349) — Composed oracle verifier for the SumcheckStep (seqCompose over ℓ')
...
- `lemma OptionT.support_mk` [ArkLib/ToVCVio/Lemmas.lean:91](../../../ArkLib/ToVCVio/Lemmas.lean#L91) — (no docstring)
...
- `lemma BCIKS20.HenselNumerator.weight_Λ_over_𝒪_add_le` [ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean:634](../../../ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean#L634) — `Λ_𝒪(a + b) ≤ max(Λ_𝒪 a, Λ_𝒪 b)`: sub-additivity over `𝒪 H`.
...
- `lemma BCIKS20.HenselNumerator.weight_Λ_over_𝒪_mul_le` [ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean:619](../../../ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean#L619) — `Λ_𝒪(a · b) ≤ Λ_𝒪(a) + Λ_𝒪(b)`: sub-multiplicativity over `𝒪 H`.  Take the canonical representatives
...
- `lemma BCIKS20.HenselNumerator.weight_Λ_over_𝒪_neg` [ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean:649](../../../ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean#L649) — `Λ_𝒪(-a) = Λ_𝒪(a)`: the `𝒪`-weight is negation-invariant (`mk (-ra) = -a`, `weight_Λ_neg`).
...
- `lemma BCIKS20.HenselNumerator.weight_Λ_over_𝒪_pow_le` [ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean:675](../../../ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean#L675) — `Λ_𝒪(a ^ k) ≤ k • Λ_𝒪(a)` (i.e. `≤ k · Λ_𝒪(a)` in `WithBot ℕ`): the power bound over `𝒪 H`, by induc
...
- `lemma BCIKS20.HenselNumerator.weight_Λ_over_𝒪_sum_le` [ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean:661](../../../ArkLib/Data/CodingTheory/ProximityGap/BCIKS20/HenselNumerator.lean#L661) — `Λ_𝒪(∑ᵢ f i) ≤ sup of Λ_𝒪(f i)`: the `𝒪`-weight of a finite sum is bounded by the sup of the summand
...
### `BBF_Code` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.BBF_Code` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:42](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L42) — The Reed-Solomon code C^(i) for round i in Binary Basefold. For each i ∈ {0, steps, ..., ℓ}, C(i) is
- `def Binius.BinaryBasefold.BBF_Code` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1761](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1761) — The Reed-Solomon code C^(i) for round i in Binary Basefold. For each i ∈ {0, steps, ..., ℓ}, C(i) is

### `BBF_CodeDistance` (2 declarations, 2 files)

- `abbrev Binius.BinaryBasefold.BBF_CodeDistance` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:92](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L92) — The (minimum) distance d_i of the code C^(i) : `dᵢ := 2^(ℓ + R - i) - 2^(ℓ - i) + 1`
- `def Binius.BinaryBasefold.BBF_CodeDistance` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1770](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1770) — The (minimum) distance d_i of the code C^(i) : `dᵢ := 2^(ℓ + R - i) - 2^(ℓ - i) + 1`

### `BBF_SumcheckMultiplierParam` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.BBF_SumcheckMultiplierParam` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:864](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L864) — (no docstring)
- `def Binius.BinaryBasefold.BBF_SumcheckMultiplierParam` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:102](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L102) — (no docstring)

### `BBF_eq_multiplier` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.BBF_eq_multiplier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:861](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L861) — (no docstring)
- `def Binius.BinaryBasefold.BBF_eq_multiplier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:90](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L90) — (no docstring)
...
- `lemma MvPolynomial.coeff_ehQ_eq_leading` [ArkLib/ToMathlib/RestrictedSumset.lean:221](../../../ArkLib/ToMathlib/RestrictedSumset.lean#L221) — The coefficient of the top monomial `X₀^{n-1} X₁^{n-2}` in `ehQ C'` (with `\|C'\| = 2(n-2)`) equals it
- `lemma MvPolynomial.coeff_ehQ_eq_leading` [ArkLib/ToMathlib/RestrictedSumsetGeneral.lean:294](../../../ArkLib/ToMathlib/RestrictedSumsetGeneral.lean#L294) — `ehQ h Cset` differs from the leading part `vdmX h · y^{\|Cset\|}` by a polynomial of strictly smaller
...
### `commitKState` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.commitKState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:707](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L707) — Knowledge state function (KState) for single round
- `def Binius.BinaryBasefold.CoreInteraction.commitKState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:375](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L375) — (no docstring)

### `commitKStateProp` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.commitKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:683](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L683) — Note : stmtIn and witMid already advances to state `(i+1)` from the fold step, while oStmtIn is not.
- `def Binius.BinaryBasefold.CoreInteraction.commitKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:351](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L351) — (no docstring)

### `commitKnowledgeError` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.commitKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:659](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L659) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.commitKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:327](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L327) — (no docstring)

### `commitOracleProver` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.commitOracleProver` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:463](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L463) — The prover for the `i`-th round of Binary commitmentfold.
- `def Binius.BinaryBasefold.CoreInteraction.commitOracleProver` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:53](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L53) — (no docstring)

### `commitOracleReduction` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.commitOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:609](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L609) — The oracle reduction that is the `i`-th round of Binary commitmentfold.
- `def Binius.BinaryBasefold.CoreInteraction.commitOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:100](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L100) — (no docstring)

### `commitOracleReduction_perfectCompleteness` (2 declarations, 2 files)

- `theorem Binius.BinaryBasefold.CoreInteraction.commitOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:635](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L635) — (no docstring)
- `theorem Binius.BinaryBasefold.CoreInteraction.commitOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:139](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L139) — (no docstring)

### `commitOracleVerifier` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.commitOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:493](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L493) — The oracle verifier for the `i`-th round of Binary commitmentfold.
- `def Binius.BinaryBasefold.CoreInteraction.commitOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:78](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L78) — (no docstring)

### `commitOracleVerifier_rbrKnowledgeSoundness` (2 declarations, 2 files)

- `theorem Binius.BinaryBasefold.CoreInteraction.commitOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:728](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L728) — RBR knowledge soundness for a single round oracle verifier
- `theorem Binius.BinaryBasefold.CoreInteraction.commitOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:510](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L510) — (no docstring)

### `commitPrvState` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.commitPrvState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:443](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L443) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.commitPrvState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:32](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L32) — (no docstring)

### `commitRbrExtractor` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.commitRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:668](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L668) — The round-by-round extractor for a single round. Since f^(0) is always available, we can invoke the 
- `def Binius.BinaryBasefold.CoreInteraction.commitRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:336](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L336) — (no docstring)
...
- `def MvPolynomial.ehQ` [ArkLib/ToMathlib/RestrictedSumset.lean:216](../../../ArkLib/ToMathlib/RestrictedSumset.lean#L216) — **The Erdős–Heilbronn polynomial** for a padded sumset `C'`.
- `def MvPolynomial.ehQ` [ArkLib/ToMathlib/RestrictedSumsetGeneral.lean:289](../../../ArkLib/ToMathlib/RestrictedSumsetGeneral.lean#L289) — **The general Erdős–Heilbronn polynomial** for a padded sumset `C'`.

### `ehY` (2 declarations, 2 files)

- `def MvPolynomial.ehY` [ArkLib/ToMathlib/RestrictedSumset.lean:165](../../../ArkLib/ToMathlib/RestrictedSumset.lean#L165) — Abbreviation for the "diagonal" variable `y = X₀ + X₁`.
- `def MvPolynomial.ehY` [ArkLib/ToMathlib/RestrictedSumsetGeneral.lean:207](../../../ArkLib/ToMathlib/RestrictedSumsetGeneral.lean#L207) — The "diagonal" variable `y = ∑_k X k`.

### `eval_ehQ_eq_zero` (2 declarations, 2 files)

- `lemma MvPolynomial.eval_ehQ_eq_zero` [ArkLib/ToMathlib/RestrictedSumset.lean:292](../../../ArkLib/ToMathlib/RestrictedSumset.lean#L292) — `ehQ Cset` vanishes at every point `s : Fin 2 → F` whose two coordinates either coincide, or sum to 
- `lemma MvPolynomial.eval_ehQ_eq_zero` [ArkLib/ToMathlib/RestrictedSumsetGeneral.lean:351](../../../ArkLib/ToMathlib/RestrictedSumsetGeneral.lean#L351) — `ehQ h Cset` vanishes at every point `s : Fin h → F` whose coordinates are not all distinct, or whos

### `fiberwiseClose` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.fiberwiseClose` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:177](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L177) — Fiberwise closeness : f^(i) is fiberwise close to C^(i) if 2 * d^(i)(f^(i), C^(i)) < d_{i+steps}
- `def Binius.BinaryBasefold.fiberwiseClose` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1812](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1812) — Fiberwise closeness : f^(i) is fiberwise close to C^(i) if 2 * d^(i)(f^(i), C^(i)) < d_{i+steps}

### `fiberwiseDisagreementSet` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.fiberwiseDisagreementSet` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:125](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L125) — Fiber-wise disagreement set Δ^(i) : The set of points y ∈ S^(i+ϑ) for which functions f^(i) and g^(i
- `def Binius.BinaryBasefold.fiberwiseDisagreementSet` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1790](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1790) — Fiber-wise disagreement set Δ^(i) : The set of points y ∈ S^(i+ϑ) for which functions f^(i) and g^(i

### `fiberwiseDistance` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.fiberwiseDistance` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:164](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L164) — Fiber-wise distance d^(i) : The minimum size of the fiber-wise disagreement set between f^(i) and an
- `def Binius.BinaryBasefold.fiberwiseDistance` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1801](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1801) — Fiber-wise distance d^(i) : The minimum size of the fiber-wise disagreement set between f^(i) and an

### `finalSumcheckRelOut` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.finalSumcheckRelOut` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:1287](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L1287) — Final sumcheck relation
- `def Binius.BinaryBasefold.finalSumcheckRelOut` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:880](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L880) — (no docstring)

### `finalSumcheckRelOutProp` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.finalSumcheckRelOutProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:1277](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L1277) — Relation for final sumcheck step
- `def Binius.BinaryBasefold.finalSumcheckRelOutProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:871](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L871) — Relation for final sumcheck step
...
### `foldKStateProp` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.foldKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:311](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L311) — This follows the KState of sum-check
- `def Binius.BinaryBasefold.CoreInteraction.foldKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:413](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L413) — (no docstring)

### `foldKnowledgeError` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.foldKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:275](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L275) — Definition of the per-round RBR KS error for Binary FoldFold. This combines the Sumcheck error (1/\|L
- `def Binius.BinaryBasefold.CoreInteraction.foldKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:362](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L362) — (no docstring)

### `foldKnowledgeStateFunction` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.foldKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:375](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L375) — Knowledge state function (KState) for single round
- `def Binius.BinaryBasefold.CoreInteraction.foldKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:465](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L465) — (no docstring)

### `foldOracleProver` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.foldOracleProver` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:105](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L105) — The prover for the `i`-th round of Binary Foldfold.
- `def Binius.BinaryBasefold.CoreInteraction.foldOracleProver` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:37](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L37) — (no docstring)

### `foldOracleReduction_perfectCompleteness` (2 declarations, 2 files)

- `theorem Binius.BinaryBasefold.CoreInteraction.foldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:238](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L238) — (no docstring)
- `theorem Binius.BinaryBasefold.CoreInteraction.foldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:150](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L150) — (no docstring)

### `foldOracleVerifier` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.foldOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:142](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L142) — The oracle verifier for the `i`-th round of Binary Foldfold.
- `def Binius.BinaryBasefold.CoreInteraction.foldOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:73](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L73) — (no docstring)

### `foldOracleVerifier_rbrKnowledgeSoundness` (2 declarations, 2 files)

- `theorem Binius.BinaryBasefold.CoreInteraction.foldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:415](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L415) — RBR knowledge soundness for a single round oracle verifier
- `theorem Binius.BinaryBasefold.CoreInteraction.foldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:1731](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L1731) — (no docstring)

### `foldRbrExtractor` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.foldRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:288](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L288) — The round-by-round extractor for a single round. Since f^(0) is always available, we can invoke the 
- `def Binius.BinaryBasefold.CoreInteraction.foldRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean:386](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Fold.lean#L386) — (no docstring)

### `foldStepRelOut` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.foldStepRelOut` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:1260](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L1260) — Input relation for round i: R_i must hold at the beginning of round i
- `def Binius.BinaryBasefold.foldStepRelOut` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:858](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L858) — (no docstring)

### `foldStepRelOutProp` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.foldStepRelOutProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:1186](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L1186) — A modified version of roundRelationProp (i+1). STATEMENT REPAIR (2026-06-04): at *non-commitment* ro
- `def Binius.BinaryBasefold.foldStepRelOutProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:782](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L782) — A modified version of roundRelationProp (i+1)

### `fold_error_containment` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.fold_error_containment` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:1026](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L1026) — **Fold error containment**: Two words achieve `fold error containment` for a specific tuple of chall
- `def Binius.BinaryBasefold.fold_error_containment` [ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean:95](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean#L95) — **Fold error containment**: Two words achieve `fold error containment` for a specific tuple of chall

### `fold_error_containment_of_UDRClose` (2 declarations, 2 files)

- `lemma Binius.BinaryBasefold.fold_error_containment_of_UDRClose` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:1043](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L1043) — (no docstring)
- `lemma Binius.BinaryBasefold.fold_error_containment_of_UDRClose` [ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean:122](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Compliance.lean#L122) — (no docstring)

### `foldingBadEventAtBlock` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.foldingBadEventAtBlock` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:913](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L913) — The bad folding event of `fᵢ` exists RIGHT AFTER the V's challenge of sumcheck round `i+ϑ-1`, this i
- `def Binius.BinaryBasefold.foldingBadEventAtBlock` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:309](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L309) — (no docstring)

### `getCommitProverFinalOutput` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.getCommitProverFinalOutput` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:451](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L451) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.getCommitProverFinalOutput` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean:40](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Commit.lean#L40) — (no docstring)

### `getFoldingChallenges` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.getFoldingChallenges` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:763](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L763) — Helper to get the k-th challenge slice for folding
- `def Binius.BinaryBasefold.getFoldingChallenges` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:34](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L34) — Helper to get the challenges for folding. k is the starting index of the challenge slice. ϑ is the n

### `getFoldingChallenges_init_succ_eq` (2 declarations, 2 files)

- `lemma Binius.BinaryBasefold.getFoldingChallenges_init_succ_eq` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:769](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L769) — (no docstring)
- `lemma Binius.BinaryBasefold.getFoldingChallenges_init_succ_eq` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:40](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L40) — (no docstring)

### `getMidCodewords` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.getMidCodewords` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:872](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L872) — This condition ensures that the folding witness `f` is properly generated from `t`
- `def Binius.BinaryBasefold.getMidCodewords` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:106](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L106) — This condition ensures that the folding witness `f` is properly generated from `t`

### `getNextOracle` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.getNextOracle` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:793](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L793) — (no docstring)
- `def Binius.BinaryBasefold.getNextOracle` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:51](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L51) — (no docstring)

### `oracleFoldingConsistencyProp` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.oracleFoldingConsistencyProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:809](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L809) — Folding consistency for round i
- `def Binius.BinaryBasefold.oracleFoldingConsistencyProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:68](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L68) — Folding consistency for round i (where i is the oracleIdx)

### `oracleFoldingConsistencyProp_relay_preserved` (2 declarations, 2 files)

- `lemma Binius.BinaryBasefold.oracleFoldingConsistencyProp_relay_preserved` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:828](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L828) — (no docstring)
- `lemma Binius.BinaryBasefold.oracleFoldingConsistencyProp_relay_preserved` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:619](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L619) — (no docstring)
...
### `relayKStateProp` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.relayKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:958](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L958) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.relayKStateProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:262](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L262) — (no docstring)

### `relayKnowledgeError` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.relayKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:939](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L939) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.relayKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:243](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L243) — (no docstring)

### `relayKnowledgeStateFunction` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.relayKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:971](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L971) — Knowledge state function (KState) for single round
- `def Binius.BinaryBasefold.CoreInteraction.relayKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:301](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L301) — (no docstring)

### `relayOracleProver` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.relayOracleProver` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:754](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L754) — The prover for the `i`-th round of Binary relayfold.
- `def Binius.BinaryBasefold.CoreInteraction.relayOracleProver` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:39](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L39) — (no docstring)

### `relayOracleReduction` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.relayOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:800](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L800) — The oracle reduction that is the `i`-th round of Binary relayfold.
- `def Binius.BinaryBasefold.CoreInteraction.relayOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:91](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L91) — (no docstring)

### `relayOracleReduction_perfectCompleteness` (2 declarations, 2 files)

- `theorem Binius.BinaryBasefold.CoreInteraction.relayOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:867](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L867) — (no docstring)
- `theorem Binius.BinaryBasefold.CoreInteraction.relayOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:137](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L137) — (no docstring)

### `relayOracleVerifier` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.relayOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:775](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L775) — The oracle verifier for the `i`-th round of Binary relayfold.
- `def Binius.BinaryBasefold.CoreInteraction.relayOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:70](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L70) — (no docstring)

### `relayOracleVerifier_rbrKnowledgeSoundness` (2 declarations, 2 files)

- `theorem Binius.BinaryBasefold.CoreInteraction.relayOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1036](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1036) — RBR knowledge soundness for a single round oracle verifier
- `theorem Binius.BinaryBasefold.CoreInteraction.relayOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:431](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L431) — (no docstring)

### `relayPrvState` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.relayPrvState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:748](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L748) — (no docstring)
- `def Binius.BinaryBasefold.CoreInteraction.relayPrvState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:33](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L33) — (no docstring)

### `relayRbrExtractor` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.CoreInteraction.relayRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:945](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L945) — The round-by-round extractor for a single round. Since f^(0) is always available, we can invoke the 
- `def Binius.BinaryBasefold.CoreInteraction.relayRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean:249](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/Relay.lean#L249) — (no docstring)

### `roundRelation` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.roundRelation` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:1270](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L1270) — Relation at step `i` of the CoreInteraction. `∀ i < ℓ, R_i` must hold at the beginning of ITERATION 
- `def Binius.BinaryBasefold.roundRelation` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:864](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L864) — (no docstring)

### `roundRelationProp` (2 declarations, 2 files)

- `def Binius.BinaryBasefold.roundRelationProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:1142](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L1142) — (no docstring)
- `def Binius.BinaryBasefold.roundRelationProp` [ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean:768](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Relations.lean#L768) — (no docstring)

### `totalDegree_ehQ_le` (2 declarations, 2 files)

- `lemma MvPolynomial.totalDegree_ehQ_le` [ArkLib/ToMathlib/RestrictedSumset.lean:263](../../../ArkLib/ToMathlib/RestrictedSumset.lean#L263) — `ehQ Cset` has total degree at most `\|Cset\| + 1`.
- `lemma MvPolynomial.totalDegree_ehQ_le` [ArkLib/ToMathlib/RestrictedSumsetGeneral.lean:332](../../../ArkLib/ToMathlib/RestrictedSumsetGeneral.lean#L332) — `ehQ h Cset` has total degree at most `deg(vdmX) + \|Cset\|`.

### `totalDegree_prod_sub_pow_le` (2 declarations, 2 files)

- `lemma MvPolynomial.totalDegree_prod_sub_pow_le` [ArkLib/ToMathlib/RestrictedSumset.lean:179](../../../ArkLib/ToMathlib/RestrictedSumset.lean#L179) — **Leading-part difference bound.** The product `∏_{c ∈ s} (y - C c)` differs from `y^{\|s\|}` by a pol
- `lemma MvPolynomial.totalDegree_prod_sub_pow_le` [ArkLib/ToMathlib/RestrictedSumsetGeneral.lean:211](../../../ArkLib/ToMathlib/RestrictedSumsetGeneral.lean#L211) — **Leading-part difference bound.** The product `∏_{c ∈ s} (y - C c)` differs from `y^{\|s\|}` by a pol
...
- **1.00** `Binius.BinaryBasefold.CoreInteraction.commitKState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:707](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L707) vs `Binius.RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:601](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L601)
    - a: Knowledge state function (KState) for single round
    - b: Knowledge state function (KState) for single round
- **1.00** `Binius.BinaryBasefold.CoreInteraction.commitKState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:707](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L707) vs `RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:636](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L636)
    - a: Knowledge state function (KState) for single round
    - b: Knowledge state function (KState) for single round
- **1.00** `Binius.BinaryBasefold.CoreInteraction.commitOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:728](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L728) vs `Binius.RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:883](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L883)
    - a: RBR knowledge soundness for a single round oracle verifier
    - b: RBR knowledge soundness for a single round oracle verifier
- **1.00** `Binius.BinaryBasefold.CoreInteraction.commitOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:728](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L728) vs `RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:843](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L843)
    - a: RBR knowledge soundness for a single round oracle verifier
    - b: RBR knowledge soundness for a single round oracle verifier
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1204](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1204) vs `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1285](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1285)
    - a: RBR knowledge error for the final sumcheck step
    - b: RBR knowledge error for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1204](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1204) vs `Binius.RingSwitching.SumcheckPhase.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1454](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1454)
    - a: RBR knowledge error for the final sumcheck step
    - b: RBR knowledge error for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1204](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1204) vs `RingSwitching.SumcheckPhase.finalSumcheckRbrKnowledgeError` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1146](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1146)
    - a: RBR knowledge error for the final sumcheck step
    - b: RBR knowledge error for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1168](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1168) vs `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:644](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L644)
    - a: The oracle reduction for the final sumcheck step
    - b: The oracle reduction for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1168](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1168) vs `Binius.RingSwitching.SumcheckPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1256](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1256)
    - a: The oracle reduction for the final sumcheck step
    - b: The oracle reduction for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1168](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1168) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:976](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L976)
    - a: The oracle reduction for the final sumcheck step
    - b: The oracle reduction for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1182](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1182) vs `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1105](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1105)
    - a: Perfect completeness for the final sumcheck step
    - b: Perfect completeness for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1182](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1182) vs `Binius.RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1270](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1270)
    - a: Perfect completeness for the final sumcheck step
    - b: Perfect completeness for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1182](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1182) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1069](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1069)
    - a: Perfect completeness for the final sumcheck step
    - b: Perfect completeness for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1310](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1310) vs `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1588](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1588)
...
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1310](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1310) vs `Binius.RingSwitching.SumcheckPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1650](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1650)
    - a: Round-by-round knowledge soundness for the final sumcheck step
    - b: Round-by-round knowledge soundness for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1310](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1310) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1328](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1328)
    - a: Round-by-round knowledge soundness for the final sumcheck step
    - b: Round-by-round knowledge soundness for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1215](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1215) vs `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1296](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1296)
    - a: The round-by-round extractor for the final sumcheck step
    - b: The round-by-round extractor for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1215](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1215) vs `RingSwitching.SumcheckPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1149](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1149)
    - a: The round-by-round extractor for the final sumcheck step
    - b: The round-by-round extractor for the final sumcheck step
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckStepLogic` [ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean:907](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/ReductionLogic.lean#L907) vs `Binius.RingSwitching.SumcheckPhase.finalSumcheckStepLogic` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:994](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L994)
...
- **1.00** `Binius.BinaryBasefold.CoreInteraction.foldKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:375](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L375) vs `Binius.RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:601](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L601)
    - a: Knowledge state function (KState) for single round
    - b: Knowledge state function (KState) for single round
- **1.00** `Binius.BinaryBasefold.CoreInteraction.foldKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:375](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L375) vs `RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:636](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L636)
    - a: Knowledge state function (KState) for single round
    - b: Knowledge state function (KState) for single round
- **1.00** `Binius.BinaryBasefold.CoreInteraction.foldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:415](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L415) vs `Binius.RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:883](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L883)
    - a: RBR knowledge soundness for a single round oracle verifier
    - b: RBR knowledge soundness for a single round oracle verifier
- **1.00** `Binius.BinaryBasefold.CoreInteraction.foldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:415](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L415) vs `RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:843](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L843)
    - a: RBR knowledge soundness for a single round oracle verifier
    - b: RBR knowledge soundness for a single round oracle verifier
- **1.00** `Binius.BinaryBasefold.CoreInteraction.relayKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:971](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L971) vs `Binius.RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:601](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L601)
    - a: Knowledge state function (KState) for single round
    - b: Knowledge state function (KState) for single round
- **1.00** `Binius.BinaryBasefold.CoreInteraction.relayKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:971](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L971) vs `RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:636](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L636)
    - a: Knowledge state function (KState) for single round
    - b: Knowledge state function (KState) for single round
- **1.00** `Binius.BinaryBasefold.CoreInteraction.relayOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1036](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1036) vs `Binius.RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:883](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L883)
    - a: RBR knowledge soundness for a single round oracle verifier
    - b: RBR knowledge soundness for a single round oracle verifier
- **1.00** `Binius.BinaryBasefold.CoreInteraction.relayOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1036](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1036) vs `RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:843](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L843)
    - a: RBR knowledge soundness for a single round oracle verifier
    - b: RBR knowledge soundness for a single round oracle verifier
...
- **1.00** `Binius.BinaryBasefold.FullBinaryBasefold.fullOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean:45](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean#L45) vs `RingSwitching.FullRingSwitching.fullOracleVerifier` [ArkLib/ProofSystem/RingSwitching/General.lean:60](../../../ArkLib/ProofSystem/RingSwitching/General.lean#L60)
    - a: The oracle verifier for the full Binary Basefold protocol
    - b: The oracle verifier for the full Binary Basefold protocol
- **1.00** `Binius.BinaryBasefold.UDRClose_of_fiberwiseClose` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:739](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L739) vs `Binius.BinaryBasefold.fiberwise_dist_lt_imp_dist_lt_unique_decoding_radius` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:2004](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L2004)
    - a: if `d⁽ⁱ⁾(f⁽ⁱ⁾, C⁽ⁱ⁾) < d_{ᵢ₊steps} / 2` (fiberwise distance), then `d(f⁽ⁱ⁾, C⁽ⁱ⁾) < dᵢ/2` (regular c
    - b: if `d⁽ⁱ⁾(f⁽ⁱ⁾, C⁽ⁱ⁾) < d_{ᵢ₊steps} / 2` (fiberwise distance), then `d(f⁽ⁱ⁾, C⁽ⁱ⁾) < dᵢ/2` (regular c
- **1.00** `Binius.BinaryBasefold.fiberwise_dist_lt_imp_dist_lt_unique_decoding_radius` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:2004](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L2004) vs `Binius.BinaryBasefold.pairUDRClose_of_pairFiberwiseClose` [ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean:647](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Code.lean#L647)
    - a: if `d⁽ⁱ⁾(f⁽ⁱ⁾, C⁽ⁱ⁾) < d_{ᵢ₊steps} / 2` (fiberwise distance), then `d(f⁽ⁱ⁾, C⁽ⁱ⁾) < dᵢ/2` (regular c
    - b: if `d⁽ⁱ⁾(f⁽ⁱ⁾, g⁽ⁱ⁾) < d_{ᵢ₊steps} / 2` (fiberwise distance), then `d(f⁽ⁱ⁾, g⁽ⁱ⁾) < dᵢ/2` (regular c
...
- **1.00** `Binius.BinaryBasefold.witnessStructuralInvariant` [ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean:892](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Basic.lean#L892) vs `RingSwitching.witnessStructuralInvariant` [ArkLib/ProofSystem/RingSwitching/Prelude.lean:435](../../../ArkLib/ProofSystem/RingSwitching/Prelude.lean#L435)
    - a: This condition ensures that the witness polynomial `H` has the correct structure `eq(...) * t(...)`
    - b: This condition ensures that the witness polynomial `H` has the correct structure `A(...) * t'(...)`
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1285](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1285) vs `Binius.RingSwitching.SumcheckPhase.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1454](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1454)
    - a: RBR knowledge error for the final sumcheck step
    - b: RBR knowledge error for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1285](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1285) vs `RingSwitching.SumcheckPhase.finalSumcheckRbrKnowledgeError` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1146](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1146)
    - a: RBR knowledge error for the final sumcheck step
    - b: RBR knowledge error for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:644](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L644) vs `Binius.RingSwitching.SumcheckPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1256](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1256)
    - a: The oracle reduction for the final sumcheck step
    - b: The oracle reduction for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:644](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L644) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:976](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L976)
    - a: The oracle reduction for the final sumcheck step
    - b: The oracle reduction for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1105](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1105) vs `Binius.RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1270](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1270)
    - a: Perfect completeness for the final sumcheck step
    - b: Perfect completeness for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:1105](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L1105) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1069](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1069)
    - a: Perfect completeness for the final sumcheck step
    - b: Perfect completeness for the final sumcheck step
...
- **1.00** `Binius.RingSwitching.BatchingPhase.batchingRBRKnowledgeError` [ArkLib/ProofSystem/Binius/RingSwitching/BatchingPhase.lean:432](../../../ArkLib/ProofSystem/Binius/RingSwitching/BatchingPhase.lean#L432) vs `RingSwitching.BatchingPhase.batchingRBRKnowledgeError` [ArkLib/ProofSystem/RingSwitching/BatchingPhase.lean:329](../../../ArkLib/ProofSystem/RingSwitching/BatchingPhase.lean#L329)
    - a: RBR knowledge soundness error for the batching phase. The only verifier randomness is `r''`. A colli
    - b: RBR knowledge soundness error for the batching phase. The only verifier randomness is `r''`. A colli
...
- **1.00** `Binius.RingSwitching.SumcheckPhase.coreInteraction_perfectCompleteness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1725](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1725) vs `RingSwitching.SumcheckPhase.coreInteraction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1457](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1457)
    - a: Perfect completeness for large-field reduction (Sumcheck ++ FinalSum)
    - b: Perfect completeness for large-field reduction (Sumcheck ++ FinalSum)
- **1.00** `Binius.RingSwitching.SumcheckPhase.coreInteraction_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1775](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1775) vs `RingSwitching.SumcheckPhase.coreInteraction_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1498](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1498)
...
- **1.00** `Binius.RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:601](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L601) vs `RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:636](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L636)
    - a: Knowledge state function (KState) for single round
    - b: Knowledge state function (KState) for single round
- **1.00** `Binius.RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:883](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L883) vs `RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:843](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L843)
    - a: RBR knowledge soundness for a single round oracle verifier
    - b: RBR knowledge soundness for a single round oracle verifier
- **1.00** `Binius.RingSwitching.SumcheckPhase.sumcheckLoopOracleReduction` [ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean:1681](../../../ArkLib/ProofSystem/Binius/RingSwitching/SumcheckPhase.lean#L1681) vs `RingSwitching.SumcheckPhase.sumcheckLoopOracleReduction` [ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean:1368](../../../ArkLib/ProofSystem/RingSwitching/SumcheckPhase.lean#L1368)
