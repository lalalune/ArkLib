...
theorem mem_support_run_of_prover_verifier
  ...
  · simp only [Option.elim_some, mem_support_bind_iff]
    ...
    · simp only [mem_support_simulateQ_liftQuery_some_iff, liftM_OptionT_eq, mem_support_bind_iff,
        support_pure, Set.mem_singleton_iff, mem_support_run_iff, support_bind, Set.mem_iUnion]
