...
theorem coreInteractionOracleReduction_perfectCompleteness (hInit : NeverFail init)
    ...
    (hCoreInteractionCompleteness :
      ...
      (relIn := strictRoundRelation (mp := BBF_SumcheckMultiplierParam) 𝔽q β (ϑ:=ϑ)
        (h_ℓ_add_R_rate := h_ℓ_add_R_rate) (𝓑:=𝓑) 0)
      (relOut := strictFinalSumcheckRelOut 𝔽q β (ϑ:=ϑ)
        (h_ℓ_add_R_rate := h_ℓ_add_R_rate))
...
#print axioms foldRelayOracleReduction_perfectCompleteness
#print axioms foldCommitOracleReduction_perfectCompleteness
#print axioms nonLastSingleBlockOracleReduction_perfectCompleteness
#print axioms lastBlockOracleReduction_perfectCompleteness
#print axioms sumcheckFoldOracleReduction_perfectCompleteness
#print axioms coreInteractionOracleReduction_perfectCompleteness
