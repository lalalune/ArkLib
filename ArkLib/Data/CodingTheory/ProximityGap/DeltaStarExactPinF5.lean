...
only ever *bounds* `ε_mca`; no exact `δ*` value has been certified for **any** code, by any
group, in any proof format. This file produces the first one, at the smallest genuinely smooth
