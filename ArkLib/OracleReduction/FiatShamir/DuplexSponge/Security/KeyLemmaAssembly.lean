...
5. `BirthdayBound.Lemma5_8EagerBirthdayResidual` is false over the deviant in-tree event
   (`Lemma58EagerFalse.lean`). Its paper-faithful replacement is
   `BirthdayBoundPaper.Lemma5_8EagerPaperResidual`.
6. `KeyLemmaFoundations.Lemma5_14HonestResidual` / `Lemma5_16HonestResidual` are false over
