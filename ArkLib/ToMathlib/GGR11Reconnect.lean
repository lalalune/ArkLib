...
* the refined residual `GGR11TreeStructure` (the Erase-Decode tree existence,
  ...
  `GGR11TreeStructure → GGR11PerWordBound → lambda_le_ggr11`-shaped bound for
  *arbitrary* budgets `b r`;
...
This makes the definitional content of `InterleavedCode.lambda_le_ggr11` available
to the reconnect theorems below: it is exactly the GGR11-budget instance of the
`GGR11Interleaved` bound shape. -/
...
theorem lambda_le_ggr11_of_treeStructure
    (C : Set (ι → F)) (δ : ℝ) (m : ℕ) (hm : 1 ≤ m)
    (hδ_lb : 0 ≤ δ) (hδ_ub : δ < (Code.minDist C : ℝ) / Fintype.card ι)
    (h : GGR11TreeStructure C δ m (ggr11BlueBudget C δ) (ggr11RedBudget C δ)) :
    InterleavedCode.lambda_le_ggr11 C δ m hm hδ_lb hδ_ub :=
  (lambda_le_ggr11_iff C δ m hm hδ_lb hδ_ub).mpr (lambda_le_ggr11_of_treeStructure h)
...
theorem lambda_le_ggr11_of_perWordBound
    (C : Set (ι → F)) (δ : ℝ) (m : ℕ) (hm : 1 ≤ m)
    (hδ_lb : 0 ≤ δ) (hδ_ub : δ < (Code.minDist C : ℝ) / Fintype.card ι)
    (h : GGR11PerWordBound C δ m (ggr11BlueBudget C δ) (ggr11RedBudget C δ)) :
    InterleavedCode.lambda_le_ggr11 C δ m hm hδ_lb hδ_ub :=
  (lambda_le_ggr11_iff C δ m hm hδ_lb hδ_ub).mpr (lambda_le_ggr11_of_perWordBound h)
...
theorem lambda_le_ggr11_of_Lambda_top
  ...
  lambda_le_ggr11_of_perWordBound C δ m hm hδ_lb hδ_ub
    (ggr11_perWordBound_of_Lambda_top hr hL)
...
example (h : GGR11TreeStructure C δ m (ggr11BlueBudget C δ) (ggr11RedBudget C δ)) :
    GGR11PerWordBound C δ m (ggr11BlueBudget C δ) (ggr11RedBudget C δ) :=
  perWordBound_of_treeStructure h
...
packaging. -/
example (h : GGR11PerWordBound C δ m (ggr11BlueBudget C δ) (ggr11RedBudget C δ)) :
    Lambda (interleavedCodeSet (κ := Fin m) C) δ ≤
      ((ggr11BlueBudget C δ + ggr11RedBudget C δ).choose (ggr11RedBudget C δ) : ℕ∞)
        * (Lambda C δ) ^ ggr11RedBudget C δ :=
  lambda_le_ggr11_of_perWordBound h
