...
\begin{remark}[What Is Proved Versus Residualized]
    ...
    hardening assumption, not a hidden proof hole. After the M2a discharge, the strict residual
    surface is:
    \[
    \begin{gathered}
    ...
    dispatcher query budgets, the M2b/M2c honest backtrack implications, simulated-prover
    budgets, and the final eager-oracle key lemma. They are deliberately exposed as named
    propositions consumed by downstream DSFS soundness reductions.
