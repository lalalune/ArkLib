...
round-by-round bridge residuals.
...
\lean{StirIOP.RoundProtocol.stirRoundReduction,StirIOP.Round3.stirRound3Reduction,StirIOP.stirFullReduction}
...
\lean{StirIOP.stirRoundReduction_perfectCompleteness,StirIOP.stirRoundVectorReduction_perfectCompleteness}
...
\begin{remark}[Current STIR status]\label{rem:stir_status}
    ...
    full degree-reduction behavior is not yet represented as an unconditional theorem.
\end{remark}
